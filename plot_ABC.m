...
for i = 1:length(year_vec)
    ...
    load(sprintf('ABC_terms_%d_%sfilt_%s%s%s_box%d_%d',L/1000,con_str,fft_str,filter_type,param_num_str,box_num,year))
    ...
    print(sprintf('/Users/ssroka/MIT/Research/eddyFlux/imgs/ABC_L_%d_%s_box%d_%d',L/1000,filter_type,box_num,year),'-dpdf')
    %%
    figure(2)
    ...
    update_figure_paper_size()
    print(sprintf('/Users/ssroka/MIT/Research/eddyFlux/imgs/components_L_%d_%s_box%d_%d',L/1000,filter_type,box_num,year),'-dpdf')
...
[C,h] = contour(lon_plot,lat_plot,nanmean(SST,3)','w','linewidth',2);
    ...
    pause(1)
    update_figure_paper_size()
    print(sprintf('/Users/ssroka/MIT/Research/eddyFlux/imgs/To_L_%d_%s_box%d_%d',L/1000,filter_type,box_num,year),'-dpdf')
    ...
    set(gcf,'color','w','position',[61 221 1359 581])
    update_figure_paper_size()
    print(sprintf('/Users/ssroka/MIT/Research/eddyFlux/imgs/To2_qo2_L_%d_%s_box%d_%d',L/1000,filter_type,box_num,year),'-dpdf')
