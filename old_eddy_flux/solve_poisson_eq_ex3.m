...
% bc eqs
e1_bc = @(location,state) 0.5.*(location.x.^2);
...
applyBoundaryCondition(model,'dirichlet','Edge',2,'u',e2_bc);
applyBoundaryCondition(model,'dirichlet','Edge',3,'u',e3_bc);
applyBoundaryCondition(model,'dirichlet','Edge',4,'u',e4_bc);
