...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.5\textwidth]{imgs/rms_error_250_fft_box3_alphabeta_2018_abCDFAC__10_10_1.pdf}};
    \draw (-2.3,-1) node[fill=white] {\large a)};
\end{tikzpicture}
\begin{tikzpicture}
    \draw (0, 0) node[inner sep=0] {\includegraphics[width=0.5\textwidth]{imgs/rms_error_250_fft_box3_alphabeta_beta_2018_abCDFAC__10_10_1.pdf}};
    \draw (-2.3,-1) node[fill=white] {\large b)};
\end{tikzpicture}
