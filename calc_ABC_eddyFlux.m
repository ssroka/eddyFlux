...
for i = 1:length(year_vec)
    ...
    switch model_str
        case 'alpha'
            ...
            save(sprintf('ABC_terms_%d_%sfilt_%s%s_box%d_%d_%s_%s_%d%s',L/1000,con_str,fft_str,filter_type,box_num,er_box_num,model_str,reanalysis_src,year,abCD_fac_str),...
