...
cf = (1/(2*L));
[SST_LP,SST_prime] = lanczos_filter(nanmean(SST_patch,3)',dx,cf);

% for i_lat = 1:length(lat_er)
% SST_LP(i_lat,:) = lanczosfilter(nanmean(SST_patch(:,i_lat,:),3)',d_lon,cf);
% end
...
print(sprintf('/Users/ssroka/MIT/Research/eddyFlux/imgs/test_lanczos_x_%d_%d',L/1000,year),'-dpdf')
