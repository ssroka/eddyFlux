...
for ii_CD = 1:length(CD_ref_vec)
    ...
    for year = [3 7]
        ...
        switch alpha_eq_flag
            case 'constant_imposed'
                as_est =@(SST_prime) alpha_vec(1);
                aL_est =@(SST_prime) alpha_vec(1);
        ...
        if as_est(0) == aL_est(1) % if the alpha's are the same constant
            ...
            if pass_num == 1
                ...
                mean_er_1_sm(ii_CD) = nanmean(nanmean(er_1_sm));
                mean_er_1_Lg(ii_CD) = nanmean(nanmean(er_1_Lg));
                ...
                mean_er_2_sm(ii_CD) = nanmean(nanmean(er_2_sm));
                mean_er_2_Lg(ii_CD) = nanmean(nanmean(er_2_Lg));
    ...
    figure(200)
    semilogx(CD_ref_vec,[mean_er_1_sm' mean_er_2_sm' mean_er_1_Lg' mean_er_2_Lg'],'-*')
...
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_1e-5_03_07','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_5e-5_03_07','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_1e-4_03_07','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_5e-4_03_07','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_1e-3_03_07','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_5e-3_03_07','-dpng')

print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_1e-5_03_07_er','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_5e-5_03_07_er','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_1e-4_03_07_er','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_5e-4_03_07_er','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_1e-3_03_07_er','-dpng')
print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/const_imp_CD_5e-3_03_07_er','-dpng')



    print('/Users/ssroka/MIT/Research/eddyFlux/imgs_channel/mean_er_fxn_CD','-dpng')
